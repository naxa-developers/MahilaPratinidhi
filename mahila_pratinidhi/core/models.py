...
class ProvinceMahilaPratinidhiForm(models.Model):
	...
	updated_mother_tongue = models.CharField(choices=MOTHER_TONGUE_CHOICES, blank=True, max_length=300, verbose_name="मातृभाषा")
	educational_qualification = models.CharField(max_length=300, verbose_name="औपचारिक शैक्षिक योग्यता", blank=True)
	updated_educational_qualification = models.CharField(choices=EDUCATIONAL_QUALIFICATION_CHOICES, blank=True, max_length=300, verbose_name="औपचारिक शैक्षिक योग्यता")
