class Kernal extends React.Component{
  constructor(props){
    super(props)
    this.kernal = this.kernal.bind(this);

  }

  componentDidMount(){
    //alert("component did mont")
    this.kernal(this.props.data[0].data);

  }


  componentWillReceiveProps(nextProps){
    d3.select('.kernal').selectAll("*").remove();
    this.kernals(nextProps.data[0].data);
 ...
 var sample = sample || faithfulData;
